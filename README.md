...
Утилита pg_restore позволяет восстанавливать данные из резервных копий. Например, чтобы восстановить только определенную БД , нужно запустить эту утилиту с параметром -d. pg_restore -d <имя базы>  <путь к вайлу с сохраненой бдж>. Чтобы сщхранить обределенную таблиу Нужно запустить утилиту с параметром -t. ПРИМЕР: pg_restore -a -t history <путь к файлу с сохраненой БД>.
